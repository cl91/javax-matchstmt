...
public final class TypingVisitor implements VoidVisitor<Object> {
	...
	public TypingVisitor(GlobalScope global) {
    ...
    public void visit(ClassOrInterfaceDeclaration n, Object arg) {
        ...
        boolean is_interface = n.isInterface();
        String name = n.getName();
        if (current_scope.resolve(name) != null)
        	throw new A2SemanticsException("multiple definitions of identifier `" + name + "', line "
        				+ n.getBeginLine() + ", column " + n.getBeginColumn());
        ClassSymbol cls = new ClassSymbol(name, current_scope,
				is_interface);
        current_scope.define(cls);
        current_scope = cls;

        // we ignore type parameters (String as in ArrayList<String>) in this assignment
        
        // we will do 'extends' in the InheritanceVisitor
        ...
        // likewise we will do 'implements' in InheritanceVisitor
